...
export function getHelpInfo(
  ...
  return {
    ...
    commands: [
      ...
      { name: '/tabs', description: 'List current session tabs' },
      { name: '/tab <op>', description: 'Switch or close session tabs' },
      { name: '/save', description: 'Force-flush messages to disk' },
      { name: '/delete <id>', description: 'Move a workspace session to trash' },
      { name: '/trash', description: 'List trashed workspace sessions' },
      { name: '/restore <id>', description: 'Restore a trashed workspace session' },
      { name: '/purge <id>', description: 'Permanently delete a workspace session' },
      { name: '/empty-trash', description: 'Permanently clear workspace trash' },
      ...
      { name: '/search [flags]', description: 'Search inside the current session' },
      ...
      { name: '/write <p> <txt>', description: 'Overwrite a workspace file using escaped text' },
